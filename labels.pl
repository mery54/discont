...
$key = q/sec:course-modell-verify/;
$external_latex_labels{$key} = q|x10-200003 x10-200003:autorefsectionCourse MsC in Computer Science: Modelling and verifying software-based systems for Master in Compurer Science of the University of Lorraine|; 
$noresave{$key} = "$nosave";
